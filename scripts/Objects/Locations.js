...
function LocationsOnOff() {
	...
	if (start==1 || chbox.checked) {
		...
		let loc = [
			...
			[1426, 138231, "Хижина братьев Сандей", icon11, "Хижина братьев Сандей"],
			...
			[-52810, 6664, "Курорт Уайтспринг", icon64, "Курорт &quotУайтспринг&quot"],
			...
			[-49734, 942, "Северный вход Уайтспринга", icon64, "Северный вход Уайтспринга"],
			[-107033, 68217, "Аванпост Опоры", icon04, "Аванпост Опоры"],
			[-112610, -76414, "Гастроли Ядер-Мира", icon42, "Гастроли &quotЯдер-Мира&quot"]
		];
