	...
	icons = new L.marker([-64897, 200091], {icon: icon_magazine3}).addTo(magazineicons).bindPopup("Исследовательский центр &quotРобКо&quot").bindTooltip("Исследовательский центр &quotРобКо&quot", {direction: 'top'});
	...
	icons = new L.marker([84461, -15851], {icon: icon_magazine3}).addTo(magazineicons).bindPopup("Переработка пищевых продуктов &quotМама Дольче&quot").bindTooltip("Переработка пищевых продуктов &quotМама Дольче&quot", {direction: 'top'});
	...
	icons = new L.marker([98395, 192590], {icon: icon_magazine3}).addTo(magazineicons).bindPopup("Электростанция &quotГрозовая гора&quot").bindTooltip("Электростанция &quotГрозовая гора&quot", {direction: 'top'});
	...
	icons = new L.marker([102094, -23035], {icon: icon_magazine2}).addTo(magazineicons).bindPopup("Терминал аэропорта Моргантауна").bindTooltip("Терминал аэропорта Моргантауна", {direction: 'top'});
