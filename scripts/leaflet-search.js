...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		propertyName: 's_title',			//property in marker.options(or feature.properties for vector layer) trough filter elements in layer,
		...
		textErr: 'Локация не найдена',	//error message
		textCancel: 'Отмена',		    //title in cancel button		
		textPlaceholder: 'Поиск локации...',   //placeholder value			
